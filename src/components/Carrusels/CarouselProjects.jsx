      ...
      <div className="relative">
        <button
          ...
          className="
            ...
            lg:-translate-x-12 md:-translate-x-8 -translate-x-2
            z-10 bg-white/10 p-3 rounded-full
          "
        >
          <FaChevronLeft />
        </button>
        ...
        >
          {proyectos.map((proyecto) => (
            <article
              key={proyecto.id}
              className="
                group snap-center relative 
                rounded-2xl bg-black 
                transition-all duration-300 
                overflow-hidden shrink-0 
                w-[75vw] sm:w-[45vw] md:w-[35vw] lg:w-80
              "
            >
